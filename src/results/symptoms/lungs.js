...
export default function SelectSymptoms(props) {
  ...
  const lungs = values.lungs; 
  const chosen = values.chosen; 
  const error = lungs.filter((v) => v).length == 0;
  const next = (e) => {
    e.preventDefault(); 
    if(!error) {
  ...
  const selected = values.luselected; 
  
  const handleSelected = (e) => {
    setVectorId('luselected', e.target.name, e.target.checked)
    if(e.target.checked == 0) {
      resetVectorId(e.target.name, "lungs"); 
    }
  }
      ...
      <Box className = {classes.media} display = "flex" justifyContent="center">
        ...
        >
          ...
          <FormGroup row>
            <FormControlLabel
              ...
              label="Stuffy Nose" name="0"
            />

            <RadioGroup className={selected[0] == 0 ? classes.visuallyHidden : ''} row name="0">
              <FormControlLabel value="1" onChange={handleVectorChange(0, "lungs")} control={<Radio checked={selected[0] == 0 ? false : (props.values.lungs[0] == 1)} />} label="1" />
              <FormControlLabel value="2" onChange={handleVectorChange(0, "lungs")} control={<Radio checked={selected[0] == 0 ? false : (props.values.lungs[0] == 2)} />} label="2" />
              <FormControlLabel value="3" onChange={handleVectorChange(0, "lungs")} control={<Radio checked={selected[0] == 0 ? false : (props.values.lungs[0] == 3)} />}  label="3" />
              <FormControlLabel value="4" onChange={handleVectorChange(0, "lungs")} control={<Radio checked={selected[0] == 0 ? false : (props.values.lungs[0] == 4)} />}  label="4" />
              <FormControlLabel value="5" onChange={handleVectorChange(0, "lungs")} control={<Radio checked={selected[0] == 0 ? false : (props.values.lungs[0] == 5)} />}  label="5" />
            </RadioGroup>
        </FormGroup>
        ...
        <FormGroup row>
            <FormControlLabel
              ...
              label="Sore Throat" name="1"
            />
            <RadioGroup className={selected[1] == 0 ? classes.visuallyHidden : ''} row name="1">
              <FormControlLabel value="1" onChange={handleVectorChange(1, "lungs")} control={<Radio checked={selected[1] == 0 ? false : (props.values.lungs[1] == 1)} />} label="1" />
              <FormControlLabel value="2" onChange={handleVectorChange(1, "lungs")} control={<Radio checked={selected[1] == 0 ? false : (props.values.lungs[1] == 2)} />} label="2" />
              <FormControlLabel value="3" onChange={handleVectorChange(1, "lungs")} control={<Radio checked={selected[1] == 0 ? false : (props.values.lungs[1] == 3)} />}  label="3" />
              <FormControlLabel value="4" onChange={handleVectorChange(1, "lungs")} control={<Radio checked={selected[1] == 0 ? false : (props.values.lungs[1] == 4)} />}  label="4" />
              <FormControlLabel value="5" onChange={handleVectorChange(1, "lungs")} control={<Radio checked={selected[1] == 0 ? false : (props.values.lungs[1] == 5)} />}  label="5" />
            </RadioGroup>
        </FormGroup>
        <FormGroup row>
            <FormControlLabel
              ...
              label="Wheezing" name="2"
            />
            <RadioGroup className={selected[2] == 0 ? classes.visuallyHidden : ''} row name="2">
              <FormControlLabel value="1" onChange={handleVectorChange(2, "lungs")} control={<Radio checked={selected[2] == 0 ? false : (props.values.lungs[2] == 1)} />} label="1" />
              <FormControlLabel value="2" onChange={handleVectorChange(2, "lungs")} control={<Radio checked={selected[2] == 0 ? false : (props.values.lungs[2] == 2)} />} label="2" />
              <FormControlLabel value="3" onChange={handleVectorChange(2, "lungs")} control={<Radio checked={selected[2] == 0 ? false : (props.values.lungs[2] == 3)} />}  label="3" />
              <FormControlLabel value="4" onChange={handleVectorChange(2, "lungs")} control={<Radio checked={selected[2] == 0 ? false : (props.values.lungs[2] == 4)} />}  label="4" />
              <FormControlLabel value="5" onChange={handleVectorChange(2, "lungs")} control={<Radio checked={selected[2] == 0 ? false : (props.values.lungs[2] == 5)} />}  label="5" />
            </RadioGroup>
        </FormGroup >
        <FormGroup row>
            <FormControlLabel
              ...
              label="Coughing" name="3"
            />
            <RadioGroup className={selected[3] == 0 ? classes.visuallyHidden : ''} row name="3">
              <FormControlLabel value="1" onChange={handleVectorChange(3, "lungs")} control={<Radio checked={selected[3] == 0 ? false : (props.values.lungs[3] == 1)} />} label="1" />
              <FormControlLabel value="2" onChange={handleVectorChange(3, "lungs")} control={<Radio checked={selected[3] == 0 ? false : (props.values.lungs[3] == 2)} />} label="2" />
              <FormControlLabel value="3" onChange={handleVectorChange(3, "lungs")} control={<Radio checked={selected[3] == 0 ? false : (props.values.lungs[3] == 3)} />}  label="3" />
              <FormControlLabel value="4" onChange={handleVectorChange(3, "lungs")} control={<Radio checked={selected[3] == 0 ? false : (props.values.lungs[3] == 4)} />}  label="4" />
